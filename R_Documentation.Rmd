...
- **Conclusion:**
    ...
    b. Casual riders have a higher weekly ride length average (11.625) than member riders (10.046).
    c. The correlation between the seasons and the number of rides is 0.588, which is closer to +1, meaning there is a strong correlation between them.
    d. The correlation between the seasons and the daily average ride length is 0.423, which is a moderate correlation meaning there is a correlation between them, but it is not strong.
    e. The number of rides increases on Saturday, Wednesday, and Thursday with the peak on Thursday.
    f. The ride length increases on Saturday and Sunday with the peak on Saturday.
    g. The top visited stations are Streeter Dr & Grand Ave, DuSable Lake Shore Dr & North Blvd, and DuSable Lake Shore Dr & Monroe St.
    h. The most used bike type is the electric bike, followed by the classic bike.
\
\
- **Recommendations:**
    ...
    3. Create a special discount at weekends for members whose ride length is longer than 20 minutes.
    4. Design merchandise such as shirts and water bottles with the company logo in the top areas.
    5. Discount on parks tickets for members who arrive with Cyclistic bikes.
    6. Increase the number of electric bikes in the docking stations.
\
\
